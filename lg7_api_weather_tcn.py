...
for line in split_data:
    ...
    tar_cur.execute(
        "insert into tb_weather_tcn( STN_ID, LON, LAT, STN_SP, HT, HT_WD, LAU_ID, STN_AD, STN_KO, STN_EN, FCT_ID, LAW_ID, BASIN, org_addr, create_dt ) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,now())",
        (STN_ID, LON, LAT, STN_SP, HT, HT_WD, LAU_ID, STN_AD, STN_KO, STN_EN, FCT_ID, LAW_ID, BASIN, line ))
    conn_tar.commit()
